...
func TestDownloadHLSURL(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := DownloadHLSURL(tt.args.url, tt.args.filename, tt.args.folder, tt.args.ps)
...
func TestDownloadHLSPlaylist(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := DownloadHLSPlaylist(tt.args.url, tt.args.storage, tt.args.ps); (err != nil) != tt.wantErr {
